 ...
 */
const ContactManagement = ({ contacts, users, onAddContact, onUpdateContact, onDeleteContact }) => {
  // State management
  ...
  const [contactToDelete, setContactToDelete] = useState(null) // New state to store contact to delete
   ...
   */
  const handleModalSubmit = (contactData) => {
    if (editingContact) {
      onUpdateContact(editingContact.id, contactData)
       setSuccessMessage("New contact Updated successfully!") // Set success message
      setShowSuccessModal(true) // Show success modal
    } else {
      onAddContact(contactData)
       setSuccessMessage("New contact added successfully!") // Set success message
      setShowSuccessModal(true) // Show success modal
    }
    setShowModal(false)
    setEditingContact(null)
  ...
  return (
    <div className="container-fluid">
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to delete contact "${contactToDelete?.name}"? This action cannot be undone.`}
      />
        {/* New Contact Added Success Modal */}
